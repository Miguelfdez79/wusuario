            ...
            <div id="lateralI">
                ...
                <div class = "contenedorusuarios">
                    ...
                    <div class="der">
                        ...
                        <div class="infousucontainer">
                            <div class="por33">
                                <p class="infotext">Active: </p>
                                <div class="infousu">
                                    <span class="spantext"><?php
                                        if ($usuarioaliasAUX2->getActivo() === "0") {
                                            echo "No";
                                        } else {
                                            echo "Yes";
                                        }
                            ...
                            <div class="por33">
                                <p class="infotext">Admin: </p>
                                <div class="infousu">
                                    <span class="spantext"><?php
                                        if ($usuarioaliasAUX2->getAdministrador() === "0") {
                                            echo "No";
                                        } else {
                                            echo "Yes";
                                        }
                            ...
                            <div class="por33">
                                <p class="infotext">Worker: </p>
                                <div class="infousu">
                                    <span class="spantext"><?php
                                        if ($usuarioaliasAUX2->getPersonal() === "0") {
                                            echo "No";
                                        } else {
                                            echo "Yes";
                                        }
